...
#include <memory>
#include "../../../src/capture/videosource.h"
...
QT_MOC_LITERAL(5, 44, 3) // "msg"
    ...
    "VideoSource\0frameReady\0\0image\0"
    "errorOccurred\0msg"
};
...
void VideoSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoSource::*)(const QImage & );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSource::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VideoSource::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_VideoSource.data,
    qt_meta_data_VideoSource,
    qt_static_metacall,
    nullptr,
    nullptr
} };
